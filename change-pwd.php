...
<div class="ajustes text-center">
    <nav class="nav nav-pills nav-fill">
        <div class="settings-menu">
            ...
            <a class="btn sidebar custom-color-sidebar  mb-sidebar-custom" aria-current="page" href="change-pwd.php">Cambiar contraseña</a>
            <a class="btn sidebar sidebar-custom" href="delete-usr.php">Eliminar cuenta</a>
        </div>   
    </nav>
    <div class="campos">
